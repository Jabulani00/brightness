...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2024 at 06:40 PM
...
--
ALTER TABLE `product_promotions`
  MODIFY `product_promotion_id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `user_rating`
  ...
  ADD CONSTRAINT `user_rating_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
COMMIT;
